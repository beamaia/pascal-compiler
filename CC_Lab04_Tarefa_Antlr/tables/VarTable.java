...
public final class VarTable {
	...
	private List<EntryInput> table = new ArrayList<EntryInput>(); 
	...
	public String toString() {
		...
		for (int i = 0; i < table.size(); i++) {
			f.format("EntryInput %d -- name: %s, line: %d, type: %s\n", i,
	...
	private final class EntryInput {
		String name;
		int line;
		Type type;
		
		EntryInput(String name, int line, Type type) {
			this.name = name;
			this.line = line;
			this.type = type;
		}
